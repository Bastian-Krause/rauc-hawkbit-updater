...
def read_xml(xml_file):
    """Returns the content of `xml_file`."""
    with open(xml_file, 'r') as f:
        return f.read()

def bundle_sha1(bundle):
    """Calculates the SHA1 checksum of `bundle`."""
    sha1 = hashlib.sha1()
...
class Installer:
    ...
    """
    dbus = read_xml('../src/rauc-installer.xml')
    ...
    def __init__(self, bundle, completed_code=0):
        self._bundle_sha1 = bundle_sha1(bundle)
    ...
    def Install(self, source):
        ...
        assert bundle_sha1(source) == self._bundle_sha1
